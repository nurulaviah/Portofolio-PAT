...
<html lang="en">
  ...
  <body>
      ...
      <div class="container" >
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="admin.php" style="color:white;">Toko Buku Saya</a>
            </li>
        ...
        <form class="d-flex">
            <ul class="nav navbar-expand-lg justify-content-end ">
                ...
                <li class="nav-right">
                    <a class="nav-link btn btn-secondary" aria-current="page" href="login.php" style="color:white;"onclick="return confirm('Anda Yakin Ingin Keluar?')">Logout</a>
                </li>
            </ul>
          </form>
        </div>
    ...
    <aside>
        <div class="box" >
            <img src="img/p.jpg" height="250px" width="250px">
            <div class="text-center mt-3">
              <h2 class="">Toko Buku Saya</h2>
              Jln.Kembang Bunga Kota Asri Harum
            </div>
        </div>
    </aside>
    <br>
